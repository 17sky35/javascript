...
// const : 같은 이름의 변수 재선언 불가능, 다시 대입하는것이 불가능
...
// 변수의 호이스팅
// 변수는 크게 '변ㄴ수 선언'과 '값 할당'으로 이루어진다.
let a;  // 변수 선언
a = 1;  // 값 할당

// 선언단계
// 변수 이름을 등록해서 자바스크립트 엔진에 의해 수의 존재를 알린다.
...
// 초기화 단계는 런타임 이전에 변수 선언문에서 이루어진다.

// console.log(b); // 변수가 있다는건 암, 초기화가 안되어있음
